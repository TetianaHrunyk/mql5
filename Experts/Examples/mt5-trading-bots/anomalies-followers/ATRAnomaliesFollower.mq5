...
bool CSampleExpert::AnomalousCandle(double price)
  {
   ...
   return atr > m_min_atr_level && ratio > InpCandleSizeChange && prev_candle_body >= m_min_candle_size;
  }
...
//  Balance max + min Drawdown + Trades Number:
   ...
   double  loss_trades = TesterStatistics(STAT_LONG_TRADES;
   return(profit_trades/loss_trades);
  }