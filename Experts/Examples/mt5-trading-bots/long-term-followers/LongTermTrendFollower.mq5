...
//+------------------------------------------------------------------+
//--- inputs for expert
input string             Expert_Title                    ="LongTermTrendFollower"; // Document name
ulong                    Expert_MagicNumber              =9571;                    //
...
//input ENUM_MA_METHOD     Signal_MA2_SlowMethod           =MODE_EMA;                // 2 Moving Averages(200,0,...) Slow method
...
input ENUM_MA_METHOD     Signal_MA2_FastMethod           =MODE_EMA;                // 2 Moving Averages(200,0,...) Fast method
input ENUM_APPLIED_PRICE Signal_MA2_FastApplied          =PRICE_CLOSE;             // 2 Moving Averages(200,0,...) Fast price
input int                Signal_MA2_TrendValidationPeriod=6;                      // 2 Moving Averages(200,0,...) Trend validtion period
